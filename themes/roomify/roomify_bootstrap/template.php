...
function roomify_bootstrap_status_messages($variables) {
  if (module_exists('better_messages')) {
    return theme_better_messages($variables);
  }
}

function roomify_bootstrap_current_search_item_wrapper(array $variables) {
...
function roomify_bootstrap_preprocess_slick_item(&$variables) {
 ...
 */
function roomify_bootstrap_field__field_listing_enquiry_dep_date($variables) {
  $output = '';
 ...
 * Implements theme_field().
 */
function roomify_bootstrap_field__field_listing_enquiry_type_ref($variables) {
  $output = '';
 ...
 * Implements theme_field().
 */
function roomify_bootstrap_field__field_listing_enquiry_guests($variables) {
  $output = '';
 ...
 * Implements theme_field().
 */
function roomify_bootstrap_field__field_listing_enquiry_arr_date($variables) {
  $output = '';
 ...
 * Implements theme_field().
 */
function roomify_bootstrap_field__field_listing_enquiry_name($variables) {
  $output = '';
 ...
 * Implements theme_field().
 */
function roomify_bootstrap_field__field_listing_enquiry_email($variables) {
  $output = '';
 ...
 * Implements theme_field().
 */
function roomify_bootstrap_field__field_listing_enquiry_info($variables) {
  $output = '';
 ...
 */
function roomify_bootstrap_preprocess_html(&$variables) {
 ...
 */
function roomify_bootstrap_preprocess_page(&$vars) {
 ...
 */
function roomify_bootstrap_process_page(&$variables) {
 ...
 */
function roomify_bootstrap_process_html(&$vars) {
  // Hook into color.module
  if (module_exists('color')) {
 ...
 */
function roomify_bootstrap_search_api_sorts_sort(array $variables) {
  $name = $variables['name'];
  $path = $variables['path'];
 ...
 */
function _roomify_bootstrap_theme_sort_indicator($style) {
  if ($style == 'asc') {
 ...
 */
function roomify_bootstrap_preprocess_mimemail_message(&$variables) {
