...
<div class="roomify-error-page 403-error-text">
  <div class="title"><?php print t('Access Denied'); ?></div>
	<div class="text"><?php print t('Well, that seems to have gone wrong. Please try again or get in touch with the site owner'); ?></div>
</div>	  
